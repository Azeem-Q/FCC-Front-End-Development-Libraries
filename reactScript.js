    ...
    _createClass(MagicEightBall, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement('input', { type: 'text', value: this.state.userInput, onChange: this.handleChange, style: inputStyle }),
...
ReactDOM.render(React.createElement(MagicEightBall, null), document.getElementById('challenge-node'));